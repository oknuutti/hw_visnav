...
class ChuryumovGerasimenko(Asteroid):
    ...
    def __init__(self, hi_res_shape_model=False, rosetta_batch='default', skip_obj_load=False):
        ...
        self.real_shape_model = None if skip_obj_load else objloader.ShapeModel(
